export const navMenu = [
    { id: "1", title: 'Home', type: 'nav', path: '/', head: "" },
    { id: "2", title: 'Partner', type: 'dropdown', path: '/partner', head: "" },
    { id: "3", title: 'พันธมิตร', type: 'nav', path: '', head: "/partner" },
    ...
    { id: "11", title: 'master', type: 'nav', path: '/master', head: "/income" },
    { id: "12", title: 'senior', type: 'nav', path: '/senior', head: "/income" },
];