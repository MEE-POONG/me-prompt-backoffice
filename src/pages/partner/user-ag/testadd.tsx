...
import { testForm } from "@/data/formData";

const TestAdd: React.FC = () => {
  const initialFormData = testForm.reduce((acc: any, curr: any) => {
  ...
  //   switch (inputTitle) {
  //     case "percent":
  //       const inputItem = testForm.find(item => item.title === "percent");
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const validationResult = testForm.reduce((acc, curr: any) => {
